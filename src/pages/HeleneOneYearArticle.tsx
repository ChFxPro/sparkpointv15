...
export default function HeleneOneYearArticle() {
  return (
    <>
      <Helmet>
        ...
        <meta property="article:published_time" content={HELENE_ONE_YEAR_DATE_ISO} />
      </Helmet>
        ...
        <article className="max-w-[760px] mx-auto px-6">
          ...
          >
            <figure>
              ...
              />
              <figcaption className="mt-4 text-center text-sm text-[#A0A0A0] italic">
                This is one of our most liked volunteer recruiting posters that we put on social media - featuring our Board President Dr. Ora Wells.
              </figcaption>
            </figure>
          </motion.div>
