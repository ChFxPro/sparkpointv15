...
| Date | Update |
| --- | --- |
| 2026-07-30 | Added `/rh_tickets` for the Rural Health Convening invitation in draft PR #95. It is wired as both a React external redirect and a QR-safe static prerender redirect to the exact secure purchase page; Vite compilation, diff checks, and real-browser destination verification passed. Review and deployment remain. |
| 2026-07-30 | Completed RH-002 in draft PR #95: added Transylvania County Tourism Development Authority as the Highlands ($1,500) convening sponsor across the webpage, Event structured data, official 5 × 7 invitation, and email copy. Verified the sponsor hierarchy on desktop/mobile, the live purchase URL, Vite production compilation, and the rendered PDF; review/deployment remain. |
